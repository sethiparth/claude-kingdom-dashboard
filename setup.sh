...
echo ""
echo "   Optional — make Claude *behave* like the kingdom (not just show it):"
echo "     • persona + working rules:  kingdom/global-CLAUDE.md  (copy into ~/.claude/CLAUDE.md; merge, don't overwrite)"
echo "     • public plugins & skills:  kingdom/PLUGINS.md        (copy-paste /plugin install commands)"
